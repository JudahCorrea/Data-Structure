...
test("Para qualquer conjunto A, ∅ ⊆ A", () => {
	expect(A.contains(new Q2023())).toBe(true);
});

//novos
test("A ∩ ∅ = ∅", () => {
	let c3 = A.intersection(new Q2023());
	expect(c3.isEqual(new Q2023())).toBe(true);
});

test("A U ∅ = A", () => {
	let c3 = A.union(new Q2023());
